  ...
  if (noClickCount < 4) {
    ...
    if (noClickCount === 4) {
      ...
      newButton.style.left = `${
        yesButtonRect.left + yesButtonRect.width / 2 + 24
      }px`;
...
yesButton.addEventListener("click", () => {
  ...
  valentineQuestion.innerHTML = `
      ...
      <br>
      <span style="font-size: 20px; color: #bd1e59;">I love you ma to my grave, i know we will not be together, but my wish is somewhere in your heart in queit corner that belongs only to u there is small place i exist, where someone who truly loved u.</span>
    `;
